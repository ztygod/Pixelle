...
import {useAppPreviewStore} from "@/features/app-preview/model/app-preview-store";
import {getPreviewUrlLabel} from "@/features/app-preview/services/preview-url-service";

export function AppPreviewSidebar() {
  const url = useAppPreviewStore((state) => state.url);
  const setViewport = useAppPreviewStore((state) => state.setViewport);
