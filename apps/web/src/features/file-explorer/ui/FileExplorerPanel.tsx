...
import {mockFileTree} from "@/features/file-explorer/model/mock-file-tree";
    ...
    <aside className="workspace-panel flex min-h-[360px] w-full flex-col overflow-hidden rounded-lg p-3 xl:h-full xl:min-h-0">
      <div className="mb-3 flex shrink-0 items-center justify-between">
        <div>
          ...
          <h2 className="text-sm font-semibold text-[#f2f5ed]">Project Explorer</h2>
        </div>
      ...
      <nav aria-label="Project files" className="min-h-0 flex-1 space-y-1 overflow-y-auto pr-1">
  ...
  return (
    <div>
      ...
      >
        ...
        <Icon className={node.type === "folder" ? "text-[#8aa0ff]" : "text-[#98a292]"} size={14} />
