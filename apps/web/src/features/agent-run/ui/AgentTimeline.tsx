...
import {timelineItems, type TimelineState} from "@/features/agent-run/model/timeline-items";
    ...
    >
      ...
      <div className="grid max-h-56 gap-2 overflow-y-auto pr-1 md:grid-cols-4 xl:max-h-48">
        {timelineItems.map((item) => (
          <article className="rounded-lg border border-white/10 bg-white/[0.03] p-3" key={item.label}>
